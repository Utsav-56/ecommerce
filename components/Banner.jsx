...
export default function Banner() {
    ...
    return isOpen && (
        <div className="w-full px-6 py-1 font-medium text-sm text-primary-foreground text-center bg-gradient-to-r from-violet-500 via-[#9938CA] to-[#E0724A]">
            <div className='flex items-center justify-between max-w-7xl  mx-auto'>
                <p>Get 20% OFF on Your First Order!</p>
                <div className="flex items-center space-x-6">
                    <button onClick={handleClaim} type="button" className="font-normal text-gray-800 bg-card px-7 py-2 rounded-full max-sm:hidden">Claim Offer</button>
